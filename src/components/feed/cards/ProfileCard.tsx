      ...
      <InteractiveCard>
        ...
        <div className={styles.header}>
          ...
          <div className={styles.content}>
            ...
            <div className={styles.availability}><span className={styles.availabilityDot} />Available for Staff/founding roles · Remote (EU/US overlap)</div>
          </div>
        </div>
        <div className={styles.hire}>
          <WipeButton href={mailto} label={payload.cta} background="#fff" color="#0a0c14" fillBg="#567cff" fillColor="#fff" />
