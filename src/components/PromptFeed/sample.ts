...
export const samplePrompt = makePrompt(
    ...
    [
        ...
        },
        {
            ...
            content: 'React with TypeScript is a powerful combination for building web applications. It provides type safety while maintaining the flexibility of React.',
            completed: true,
            meta: {
